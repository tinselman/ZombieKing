...
export const WEAPONS: WeaponDef[] = [
  ...
  { id: 'babynuke', name: 'Baby Nuke', ammo: 0, blast: 6.0, kind: 'blast', price: 1800, pack: 1 },
  { id: 'nuke', name: 'Nuke', ammo: 0, blast: 9.5, kind: 'blast', price: 4500, pack: 1 },
  { id: 'frisbee', name: 'Frisbee Bomb', ammo: 0, blast: 9.5, kind: 'frisbee', price: 4500, pack: 1 },
  ...
  { id: 'deathshead', name: "Death's Head", ammo: 0, blast: 5.5, kind: 'mirv', split: 7, price: 6500, pack: 1 },
